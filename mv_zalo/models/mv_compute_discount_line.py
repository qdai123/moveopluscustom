...
class MvComputeDiscountLine(models.Model):
    ...
    def _get_zns_template(self):
        ...
        return ICPSudo.get_param(ZNS_CKSL_POLICY_NOTIFICATION_TEMPLATE, "")
    ...
    @api.depends("partner_id", "partner_id.amount_currency", "total_money")
    def _compute_amount_update(self):
        for record in self:
            record.partner_total_discount_amount = record.total_money
    ...
    def action_send_message_zns(self):
        ...
        context = {
            ...
            "default_mv_compute_discount_id": self.parent_id.id,
