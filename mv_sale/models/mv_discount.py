...
class MvDiscountPolicy(models.Model):
    ...
    def _compute_first_quarter(self):
        for record in self:
            record.forecasted_sales_first_quarterly = (
    ...
    def _compute_second_quarter(self):
        for record in self:
            record.forecasted_sales_second_quarterly = (
    ...
    def _compute_third_quarter(self):
        for record in self:
            record.forecasted_sales_third_quarterly = (
    ...
    def _compute_fourth_quarter(self):
        for record in self:
            record.forecasted_sales_fourth_quarterly = (
    ...
    def _onchange_in_year(self):
        if not self.in_year:
            self._reset_monthly_fields()

    def _reset_monthly_fields(self):
        self.january = 0.0
        self.february = 0.0
        self.march = 0.0
        self.april = 0.0
