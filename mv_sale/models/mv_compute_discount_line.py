...
class MvComputeDiscountLine(models.Model):
    ...
    month = fields.Float(string="Tháng")
    month_money = fields.Integer(string="Số tền")
    is_two_month = fields.Boolean()
    amount_two_month = fields.Float(string="Số tiền 2 Tháng")
    two_month = fields.Float(string="2 Tháng")
    two_money = fields.Integer(string="Số tiền")
    is_quarter = fields.Boolean()
    quarter = fields.Float(string="Quý")
    quarter_money = fields.Integer(string="Số tiền ")
    is_year = fields.Boolean()
    year = fields.Float(string="Năm")
    year_money = fields.Integer(string="Số tiền")
