...
class MvReportDiscount(models.TransientModel):
    ...
    type = fields.Selection([('1', 'Chiết khấu 2 tháng'), ('2', 'Chiết khấu theo quý'), ('3', 'Chiết khấu theo năm')])
    value_month = fields.Selection([('1', 'Tháng 12 năm trước và 1 năm nay'), ('2', 'Tháng 1 và 2'), ('3', 'Tháng 2 và 3'), ('4', 'Tháng 3 và 4'),
                                    ('5', 'Tháng 4 và 5'), ('6', 'Tháng 5 và 6'), ('7', 'Tháng 6 và 7'),
                                    ('8', 'Tháng 7 và 8'), ('9', 'Tháng 8 và 9'), ('10', 'Tháng 9 và 10'),
                                    ('11', 'Tháng 10 và 11'), ('12', 'Tháng 11 và 12')], string="Tháng")
    ...
    def action_view_two_month(self):
        ...
        line_ids = self.env['mv.compute.discount.line'].search(
            [('partner_id', '=', self.partner_id.id), ('is_two_month', '=', True), ('name', '=', name)])
        if len(line_ids) == 0:
            return {
    ...
    def action_view_quarter(self):
        ...
        year = self.year
        name = month + '/' + year
        line_ids = self.env['mv.compute.discount.line'].search([('partner_id', '=', self.partner_id.id), ('is_quarter', '=', True),('name', '=', name)])
        if len(line_ids) == 0:
            return {
    ...
    def action_view_year(self):
        ...
        list_name = ['1' + '/' + year, '2' + '/' + year, '3' + '/' + year, '4' + '/' + year, '5' + '/' + year,
                     ...
                     '12' + '/' + year]
        line_ids = self.env['mv.compute.discount.line'].search(
            [('partner_id', '=', self.partner_id.id), ('is_year', '=', True), ('name', '=', '12' + '/' + year)])
        if len(line_ids) == 0:
            return {
